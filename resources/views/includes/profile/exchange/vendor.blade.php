    <h1 class="my-3">
        ...
        Exchanage 
    	<span class="text-right badge badge-success " style="font-size: 14px;">USD to COIN</span>
    </h1>
                ...
                <form action="{{ route('profile.exchange.detail') }}" method="POST">
                    ...
                    <div class="form-row">
                	  	<div class="col-md-5 col-sm-12">
                            <input type="number" step="0.1" max="{{auth()->user()->usd_balance}}" min="0.00" class="form-control form-control-md d-flex" name="balance" id="balance" placeholder="0.00" 
                            value="0.00" >
                        </div>
                        <div class="col-md-2 col-sm-12">
                        	<h4 class="text-center text-light"><i class="fas fa-exchange-alt"></i></h4>
                        </div>
                        <div class="col-md-5 col-sm-12">
                        ...
                        <h6 class=" col-md-12 text-center text-light mt-2">
                            <span class="badge badge-info">$1 USD</span>
                            <i class="fas fa-exchange-alt"></i> 
                            <span class="badge badge-success">{{$usdToBtc}} BTC</span>
                        </h6>
                        <h6 class="col-md-12  text-center text-light">
                            <span class="badge badge-info">$1 USD</span>
                            <i class="fas fa-exchange-alt"></i> 
                            <span class="badge badge-success">${{$usdToXmr}} XMR</span>
                        </h6>
