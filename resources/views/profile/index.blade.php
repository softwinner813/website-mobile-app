...
<h2 class="my-3"><i class="fas fa-lock"></i> Settings</h2>
<hr>
<div class="mainOwnDiv">
    <div class="row">
        <div class="col-md-6">
            <h4 class="mt-4"><i class="fas fa-lock"></i> Change password</h4>
            <div class="">
                <hr>
                <form action="{{ route('profile.password.change') }}" method="POST" class="justify-content-between">
                    ...
                    <div class="form-row my-2">
                        ...
                        <input type="password" class="form-control @error('new_password', $errors) is-invalid @enderror" id="cn_password" name="new_password_confirmation" placeholder="Confirm new password">
                    </div>
