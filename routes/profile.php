...
Route::prefix('profile')->group(function(){
     ...
     * @Auth: Genius Dev
     * @Date: 2021.12
     * @Desc: Deposit into account via Bitcoin or Monero
     ****************************/
    Route::get('deposit/', 'ProfileController@deposit') -> name('profile.deposit');
    Route::post('deposit/getAddress', 'ProfileController@getAddress') -> name('profile.deposit.getAddress');
    Route::get('deposit/add/{id}', 'ProfileController@addDepositMoney') -> name('profile.deposit.add'); 
    Route::get('deposit/delete/{id}', 'ProfileController@deleteDeposit') -> name('profile.deposit.delete'); 


    /***
     * Exchage Coin to USD
     */
    Route::get('exchange/', 'ProfileController@exchange') -> name('profile.exchange');
    Route::post('exchange/', 'ProfileController@exchangeDetail') -> name('profile.exchange.detail');
    Route::get('exchange/submit/{coin}/{balance}', 'ProfileController@exchangeSubmit') -> name('profile.exchange.submit');
